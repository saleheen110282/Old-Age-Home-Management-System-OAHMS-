                <div style="position: relative; z-index: 9999; display: inline-block; float: right; margin-right: 30px;">
                    <div id="profileMenu" style="position: absolute; right: 0; display: none; border-radius: 5px; height: 180px; width: 160px; font-size: 17px; background-color: #DDDDDD; color: #5A5454;">
                        ...
                        <hr>
                        <div style="padding: 10px; text-align: center;"><a style="text-decoration: none; color: #5A5454;" href="myprofile.php">Settings</a></div>
                        <hr>
